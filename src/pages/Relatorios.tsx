  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-3 pb-24">
      <header className="flex items-center justify-between">
        ...
        <Link
          to="/relatorios/novo"
          className="flex items-center gap-1.5 rounded-xl bg-gray-900 px-3.5 py-2 text-sm font-medium text-white"
        >
          <Plus size={16} /> Novo
        </Link>
      </header>
      ...
      {!carregando && relatorios.length === 0 && (
        <div className="rounded-2xl bg-white shadow-sm p-8 text-center space-y-2">
          <FileText className="mx-auto text-gray-300" size={28} />
          <p className="text-sm text-gray-400">Nenhum relatório criado ainda.</p>
        </div>
      )}
